...
from square_database.pydantic_models.pydantic_models import InsertRow
...
async def insert_rows(insert_rows_model: InsertRow):
    try:
            ...
            try:
                ...
                table_module_path = \
                    (f'{module_name}.{databases_folder_name}'
                     f'.{insert_rows_model.database_name.value}.{insert_rows_model.schema_name.value}.{insert_rows_model.table_name.value}')
